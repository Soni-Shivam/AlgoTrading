# Third version; added Bollinger Bands to the mean reversion logic.
...
class Trader:
    ...
    def run(self, state, current_position):
        ...
        if mid_price < lower_band and zscore < -self.k and current_position < self.position_limit:
            orders.append(Order("PRODUCT", best_bid, self.order_size))

        elif mid_price > upper_band and zscore > self.k and current_position > -self.position_limit:
